...
$errorMessage = $_GET['message'] ?? 'Ein unbekannter Fehler ist aufgetreten.';
...
<head>
    ...
    <title>Fehler <?= h($errorCode) ?> | <?= h($config['site']['title']) ?></title>
    ...
    <main class="error-content">
        <div class="container">
            <div class="error-card">
                <div class="error-number"><?= h($errorCode) ?></div>
